# Opioid Convert Script was created as part of the University of Illinois iSchool's LIS 452
# final project in Fall 2017.

# The original code was created by Elizabeth Wickes, MLIS, on  12/15/2017.
# All subsequent modifications were implemented by Daria Orlowska.
# Project progress was tracked on Daria Orlowska's GitHub: https://github.com/dorlow2/452_finalproject

# Last updated: 1/9/2018


source = '/Users/daria/Desktop/Opioid_Palm_data'
import os
...
import pandas as pd
# for each file name in the list, do the following
for file in fn_list:
	# Import the .txt document, and read in assigning headers
	file_name = '/Users/daria/Desktop/Opioid_Palm_data/' + file
	...
	replace_dict = {"Yes": "1", "No": "0", "a) more than 8 hours": "1", "b) 7-8 hours": "2", "c) 5-6 hours": "3",
					...
					"a) more than 8": "1", "2 good": "2", "1 very good": "1", "8 the whole time": "8",
					"8 extremely": "8", "6 very much": "6", "4 much": "4", "2 somewhat": "2", "0 not at all": "0",
					"6 much": "6", "2 a little": "2", "6 very": "6", "4 somewhat": "4", "0 none": "0", "1 1-10min": "1",
	...
	# remove the temporary csv file created as a way of reading in data
